...
CHANGELOG_URL = "https://docs.cloud.coinbase.com/exchange/docs/changelog"
LATEST_UPDATE = "2024-FEB-22"
# curl https://docs.cloud.coinbase.com/exchange/docs/changelog | md5sum
CHANGELOG_HASH = "4825e9a0e67b58f6be38f7e411637b87"

COINBASE_EXCHANGE_CLASS_PREFIX = "CoinbaseExchange"

DEFAULT_DOMAIN = "com"

HBOT_ORDER_ID_PREFIX = "CBEX-"
MAX_ORDER_ID_LEN = 32
HBOT_BROKER_ID = "Hummingbot"

# Base URL
SIGNIN_URL = "https://api.exchange.coinbase.{domain}/v2"
REST_URL = "https://api.exchange.coinbase.{domain}/api/v3"
WSS_URL = "wss://ws-feed.exchange.coinbase.{domain}"

# Coinbase Exchange API endpoints
...
WS_ORDER_SUBSCRIPTION_KEYS: Tuple[str, ...] = ("level2", "matches")
WS_ORDER_SUBSCRIPTION_CHANNELS: bidict[str, str] = bidict({k: k for k in WS_ORDER_SUBSCRIPTION_KEYS})
WS_ORDER_SUBSCRIPTION_CHANNELS["level2"] = "l2update"
